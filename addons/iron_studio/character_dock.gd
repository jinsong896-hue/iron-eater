...
@onready var _sprite: LineEdit = $Main/HSplit/EditPanel/Scroll/VBox/Identity/Sprite
@onready var _hp: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/HP
@onready var _atk: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/ATK
@onready var _def: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/DEF
@onready var _spd: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/SPD
@onready var _aspd: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/ASPD
@onready var _crt: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Stats/CRT
@onready var _skill_list: ItemList = $Main/HSplit/EditPanel/Scroll/VBox/Skills/SkillList
@onready var _avail_list: ItemList = $Main/HSplit/EditPanel/Scroll/VBox/Skills/AvailList
...
@onready var _form_sp: LineEdit = $Main/HSplit/EditPanel/Scroll/VBox/Forms/FormSprite
@onready var _mod_atk: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Forms/ModATK
@onready var _mod_hp: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Forms/ModHP
@onready var _mod_spd: SpinBox = $Main/HSplit/EditPanel/Scroll/VBox/Forms/ModSPD
